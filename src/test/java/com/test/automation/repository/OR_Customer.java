...
public class OR_Customer extends Page {
	...
	public By CustomerPage = By.xpath("//*[@class='line']");
	public WebElement validateCustomerPage() {
		se.element().waitForElement(CustomerPage);
		return se.element().getElement(CustomerPage);
	} 
	...
	public By SelectAll = By.xpath("//*[contains(text(),'Select All  ')]");
	public WebElement GetSelectAll() {
		se.element().waitForElement(SelectAll);
		return se.element().getElement(SelectAll);
	}
	
	public By CommercialAuto = By.xpath("//*[contains(text(),' Commercial Auto')]");
	...
	public By DuplicateAccount = By.xpath("//*[@name='Duplicate']");
	public WebElement ClickDuplicateAccount() {
		se.element().waitForElement(DuplicateAccount);
		return se.element().getElement(DuplicateAccount);
	}
	
	public By SelectAndProceed = By.xpath("//*[@id='existingAccountpopup']/div/div/div[3]/button");
	public WebElement ClickSelectAndProceed() {
		se.element().waitForElement(SelectAndProceed);
		return se.element().getElement(SelectAndProceed);
	}
